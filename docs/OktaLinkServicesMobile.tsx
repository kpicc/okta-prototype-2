...
interface OktaLinkServicesMobileProps {
  onBack: () => void;
  onContinue?: () => void;
}
...
export function OktaLinkServicesMobile({ onBack, onContinue }: OktaLinkServicesMobileProps) {
  ...
  return (
    <div className="okta-link-mobile">
      ...
      <main className="okta-link-mobile__body">
        {/* Success banner */}
        <div className="okta-link-mobile__banner">
          <img src="/okta/icon-success.svg" alt="" width={24} height={24} />
          <span className="okta-link-mobile__banner-text">Your account login has been updated.</span>
        </div>

        {/* Card */}
        <div className="okta-link-mobile__card okta-link-mobile__card--services">
          <h2 className="okta-link-mobile__card-title">Next, link your current services</h2>
        ...
        {/* Promo */}
        <div className="okta-link-mobile__promo">
          <span className="okta-link-mobile__promo-text">Not yet a Freedom customer?</span>
          <a href="#" className="okta-link-mobile__promo-link" onClick={(e) => e.preventDefault()}>Shop our special offers</a>
        </div>
      </main>
